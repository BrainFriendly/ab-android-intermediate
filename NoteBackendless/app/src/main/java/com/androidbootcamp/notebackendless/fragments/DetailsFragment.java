package com.androidbootcamp.notebackendless.fragments;
...
public class DetailsFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        {
            //TODO mostrar INFO
            String name= noteEntity.getTitle()!=null?(noteEntity.getTitle().toString()):("");
            String desc= noteEntity.getDescription()!=null?(noteEntity.getDescription().toString()):("");
